...
rectangle TABsucks{
    usecase "UC1: 导入音频" as UC1
    usecase "UC2: 分离音轨" as UC2
    usecase "UC3: 分析节奏" as UC3
    usecase "UC4: 分析和弦" as UC4
    usecase "UC5: 播放控制\n(调速/循环/静音)" as UC5
    usecase "UC6: 导出MIDI" as UC6
    usecase "UC7: 查看可视化图表" as UC7
    usecase "UC8: 更新模型" as UC8
    
    usecase "节拍跟踪 (Beat Tracking)" as UC3_1
    usecase "节奏型识别 (Pattern Recognition)" as UC3_2
}
...
class ChordAnalyzer {
  - chordModel: ChordRecognitionModel
